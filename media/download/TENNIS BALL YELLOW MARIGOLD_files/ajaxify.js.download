...
var ajaxifyShopify = (function(module, $) {
  ...
  flipCartUpdateCallback = function (cart) {
    ...
    window.dataLayer.push({
      'event': 'cart_view',
      'total_items': parseInt($('#cartCount').text()),
      'cart_total': parseInt(cart.total_price/100),
      'quantity': parseInt($('#cartCount').text()),
      'prod_count': parseInt($('#cartCount').text()),
      'device':ua,
      'Special instructions': cart.note,
      'Total amount': parseInt(cart.total_price/100)
    });
    buildCart(cart);
  };
  ...
  adjustCart = function () {
    ...
    $('.ajaxifyCart--remove').on('click', function(e) {debugger;
       var discount = 0;
     if(parseInt($(this).attr('data-compareprice')/100) > parseInt($(this).attr('data-price')/100)){
      discount = parseInt($(this).attr('data-compareprice')/100) - parseInt($(this).attr('data-price')/100);
    }
     window.dataLayer = window.dataLayer || [];  
     window.dataLayer.push({
      'event': 'remove_from_cart',
      'prod_id': $(this).attr('data-id'),
      'prod_name': $(this).attr('data-title'),
      'produrl': $(this).attr('data-url'),
      'image_url':$(this).attr('data-imgurl'),
      ...
      'mrp': parseInt($(this).attr('data-compareprice')/100),
      'discount': discount,
      'description': $(this).attr('data-desc'),
      'Special instructions': $(this).attr('data-note'),
      'Total amount': parseInt($(this).attr('data-carttotal'))
    })
